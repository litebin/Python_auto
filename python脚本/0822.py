...
from wd_userdata import get_userinfo
from wd_userdata import get_webinfo
'''
...
if __name__ == '__main__':
    ele_dict = get_webinfo(r'C:\Users\Administrator\Desktop\python脚本\wd_webinfo.txt')
    account_dict = get_userinfo(r'C:\Users\Administrator\Desktop\python脚本\wd_userinfo.txt')
    login_test()
